...
|-----------|-----------|---------|-----------|
| Framework | Next.js (App Router) | 15.x | SSR, API Routes, estructura de app |
| Frontend | React | 19.x | UI reactiva |
| Lenguaje | TypeScript | 5.x | Tipado estricto |
| Estilos | TailwindCSS | 4.x | Utility-first CSS |
| Componentes | shadcn/ui | latest | Componentes accesibles y personalizables |
